...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="mayfly-user 15 AQ3A.250226.002 OS3.0.3.0.VLTCNXM release-keys" \
    BuildFingerprint=Xiaomi/mayfly/mayfly:15/AQ3A.250226.002/OS3.0.3.0.VLTCNXM:user/release-keys \
